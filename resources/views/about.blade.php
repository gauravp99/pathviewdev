        ...
        <div class="col-sm-12">
            <div class="col-sm-8 corousel-content ">
                ...
                <p class="content1">
                    ...
                    Pathview Web provides easy interactive access, and generates high quality, hyperlinked graphs. Pathview package is written in R/Bioconductor, this web interface is built on PHP with Laravel Framework , XAMPP and R.
                </p>
