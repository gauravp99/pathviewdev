    ...
    <div class="col-sm-8">
        ...
        <div class="col-sm-10">
            <div class="col-sm-12" style="padding:40px;margin:40px;font-size: 25px;">
                <form class="form-horizontal" id="form-contact" role="form" method="post" accept-charset="UTF-8"
                      enctype="multipart/form-data" action="/postMessage">
                    ...
                    <div class="form-group col-md-offset-5">
                        ...
                        <label for="email" class="col-sm-3 control-label"><span class=""><i
                                        class="glyphicon glyphicon-paperclip"></i></span></label>
        ...
        <span class="input-group-btn">
          <button class="browse btn btn-primary" type="button"><i class="glyphicon glyphicon-search"></i> Browse
          </button>
        </span>
                        </div>
                    </div>
