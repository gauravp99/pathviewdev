...
<script src="js/jquery.validate.min.js"></script>
    ...
    <div class="col-sm-12">
<h2 style="font-family:fantasy;">Send yor feedback or any issue with the project. Admin will try to resolve and revert back to you</h2>
        <div class="col-sm-8">
            <div class="col-sm-8" style="padding:40px;margin:40px;font-size: 25px;">
<form class="form-horizontal" id="form-contact" role="form" method="post"  accept-charset="UTF-8" enctype="multipart/form-data" action="/postMessage">
    ...
    <div class="form-group col-sm-offset-5" >
        ...
        <label for="email" class="col-sm-2 control-label"><span class=""><i class="glyphicon glyphicon-paperclip"></i></span></label>
    <div class="input-group col-xs-6  col-sm-offset-2 " style="margin-left:18.5%;">

        <span class="input-group-addon"><i class="glyphicon glyphicon-picture"></i></span>
        <input type="text" id="form-control" class="form-control" disabled placeholder="Upload Image">
