...
">
    ...
    <div class="col-sm-4 multiple-columns-stepsDiv">
        ...
        <div class="col-sm-12">
            <input type="checkbox" id="countData" value="true" data-off-text="FALSE" data-on-text="TRUE" data-size="small" style="width: 44px;" name="countData"
    ...
    <div class="col-sm-4 multiple-columns-stepsDiv ">
            ...
            <div class="col-sm-4">
                <input type="checkbox" id="normalizedData" value="true" data-off-text="FALSE" data-on-text="TRUE" data-size="small" style="width: 44px;" name="normalizedData"
...
<div class="stepsdiv" id="gset-div">
  ...
  <select name="geneSet[]" id="geneSet" class="geneSet" multiple size="10" style="width:100%;">
                ...
                <option value="custom"
                        style="background-color: whitesmoke;font-weight: bold;margin-left:-1px;width:101%;">Custom
                </option>
            </select>
    ...
    <div class="col-sm-12">
        ...
        <div class="col-sm-7" id="geneid">
            <select class="styled-select" name="geneIdType" id="geneIdType">
                ...
                <?php }else { ?>
                <option value="ACCNUM" @if (strcmp(strtoupper($geneIdType),'ACCNUM') == 0 ) selected @endif>ACCNUM
                </option>
                <option value="ENSEMBL" @if (strcmp(strtoupper($geneIdType),'ENSEMBL') == 0 ) selected @endif >ENSEMBL
                </option>
                <option value="ENSEMBLPROT" @if (strcmp(strtoupper($geneIdType),'ENSEMBLPROT') == 0 ) selected @endif >
                    ENSEMBLPROT
                </option>
                <option value="ENSEMBLTRANS"
                        @if (strcmp(strtoupper($geneIdType),'ENSEMBLTRANS') == 0 ) selected @endif >ENSEMBLTRANS
                </option>
                <option value="ENTREZ" @if (strcmp(strtoupper($geneIdType),'ENTREZ') == 0 ) selected @endif >ENTREZ
                </option>
                <option value="ENZYME" @if (strcmp(strtoupper($geneIdType),'ENZYME') == 0 ) selected @endif >ENZYME
                </option>
                <option value="GENENAME" @if (strcmp(strtoupper($geneIdType),'GENENAME') == 0 ) selected @endif >
                    GENENAME
                </option>
                <option value="KEGG" @if (strcmp(strtoupper($geneIdType),'KEGG') == 0 ) selected @endif >KEGG</option>
                <option value="PROSITE" @if (strcmp(strtoupper($geneIdType),'PROSITE') == 0 ) selected @endif >PROSITE
                </option>
                <option value="REFSEQ" @if (strcmp(strtoupper($geneIdType),'REFSEQ') == 0 ) selected @endif >REFSEQ
                </option>
                <option value="SYMBOL" @if (strcmp(strtoupper($geneIdType),'SYMBOL') == 0 ) selected @endif >SYMBOL
                </option>
                <option value="UNIGENE" @if (strcmp(strtoupper($geneIdType),'UNIGENE') == 0 ) selected @endif >UNIGENE
                </option>
...
<fieldset class="step analysis-step">
    ...
    <div class="stepsdiv" id="setSize-div">
        <div class="col-sm-12">
            <div class="col-sm-5">
                ...
                <h4 for="setSize" style="max-width: 100%;margin-top:20px;font-weight: bold;margin-left: 116px;">
                    Maximum:</h4>
            </div>
            <div class="col-sm-7">

                <input class="ex8" style="" name="setSizeMin" id="setSizeMin" value={{$setSizeMin}}  placeholder="5">
                <input class="ex8" style="margin-top:20px;" name="setSizeMax" class="MaxGreaterThanMinCheck"
                       data-min="setSizeMin" id="setSizeMax" value={{$setSizeMax}} placeholder="100">
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-7">
                <select name="test" id="test" class="styled-select" class="compare">
                    ...
                    <option value="gs.KSTest" @if (strcmp($test,'gs.KSTest') == 0 ) selected @endif >Kolmogorov–Smirnov
                        test
                    </option>
                </select>
            </div>
    ...
    <div class="stepsdiv" id="pathviewSettings-div">
        <div class="col-sm-12">
            ...
            <div class="col-sm-7">
                <select name="pathviewSettings" class="styled-select" id="pathviewSettings"
                        class="compare">
...
<fieldset class="step">
        ...
        <div class="col-sm-12">
            <div class="col-sm-6">
                <a href="tutorial#desc"
                   ...
                   title="Whether gene data should be treated as discrete." target="_blank"
                   class="scrollToTop" style="float:left;margin-right:5px;">
                    <span class="glyphicon glyphicon-info-sign" style="margin-right: 20px;"></span>
                </a>
            ...
            <div class="col-sm-6">
                <a href="tutorial#desc"
                   onclick="window.open('tutorial#desc', 'newwindow', 'width=300, height=250').focus();return false;"
                   title="Whether compound data should be treated as discrete." target="_blank"
                   class="scrollToTop" style="float:left;margin-right:5px;">
                    <span class="glyphicon glyphicon-info-sign" style="margin-right: 20px;"></span>
                </a>
        ...
        <div class="col-sm-12">
            <div class="col-sm-6">
                <a href="tutorial#split"
                   ...
                   title="Whether split node groups are split to individual nodes." target="_blank"
                   class="scrollToTop" style="float:left;margin-right:5px;">
                    <span class="glyphicon glyphicon-info-sign" style="margin-right: 20px;"> </span>
                </a>
            ...
            <div class="col-sm-6">
                <a href="tutorial#expand"
                   ...
                   title="Whether the multiple-gene nodes are expanded into single-gene nodes"
                   target="_blank" class="scrollToTop" style="float:left;margin-right:5px;">
                    <span class="glyphicon glyphicon-info-sign" style="margin-right: 20px;"></span>
                </a>
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-6">
                <a href="tutorial#match"
                   ...
                   title="Whether the samples of gene data and Compound data are paired"
                   target="_blank" class="scrollToTop" style="float:left;margin-right:5px;">
                    <span class="glyphicon glyphicon-info-sign" style="margin-right: 20px;"></span>
                </a>
                {!!form::label('matchd','Match Data:') !!}
                <input name="matchd" value="T" id="matchd"
                       <?php if (isset(Session::get('Sess')['matchd'])) {
                           echo "checked";
                       } else {
                           if (Session::get('Sess') == NULL) {
                               if ($matchd) {
    ...
    <div class="stepsdiv" id="kalgin-div">
        <div class="col-sm-12">
            ...
            <div class="col-sm-6">
                {!!form::select('align', array('x' => 'x', 'y' => 'y'), isset(Session::get('Sess')['align']) ? Session::get('Sess')['align'] : $align,array('id'=>'align')) !!}
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="col-sm-6">
                <a href="tutorial#spos"
                   ...
                   title="Controls the position of pathview signature." target="_blank"
                   class="scrollToTop" style="float:left;margin-right:5px">
                    <span class="glyphicon glyphicon-info-sign" style="margin-right: 20px;"></span>
                </a>
...
<fieldset class="step">
    ...
    <div class="stepsdiv" id="glow-clow-div"<?php if (isset(Session::get('err_atr')['glow'])) {
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-8">
                <input class="jscolor coloration {hash:true}" id="glow" name="glow"
                       value={{isset(Session::get('genecolor')['glow']) ? Session::get('genecolor')['glow'] : '#00FF00'}}>
                <input class="jscolor coloration {hash:true}" id="clow" name="clow"
    ...
    <div class="stepsdiv" id="gmid-cmid-div" <?php if (isset(Session::get('err_atr')['gmid'])) {
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-8">
                <input class="jscolor coloration {hash:true}" id="gmid" name="gmid"
                       value={{isset(Session::get('genecolor')['gmid']) ? Session::get('genecolor')['gmid'] : '#D3D3D3'}}>
                <input class="jscolor coloration {hash:true}" id="cmid" name="cmid"
                       style="margin-left:50px"
    ...
    <div class="stepsdiv" id="ghigh-chigh-div"<?php if (isset(Session::get('err_atr')['ghigh'])) {
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-8">
                <input class="jscolor coloration {hash:true}" id="ghigh" name="ghigh"
                       value={{isset(Session::get('genecolor')['ghigh']) ? Session::get('genecolor')['ghigh'] : '#FF0000'}}>
                <input class="jscolor coloration {hash:true}" id="chigh" name="chigh"
                       style="margin-left:50px"
...
<script>
    ...
    var validator = $('#gage_anal_form').validate({
        ...
        messages: {
            ...
            species: {
                ...
                speciesValid: "*  Invalid species entered"
            },
            compare: {
