        ...
        <!--[if (lt IE 10)]></select><![endif]-->
                        ...
                        <div class="stepsdiv" id="ref-div">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-7">
                                    <input class="ex8" name="reference" id="reference" value={{$reference}}> <h6
                                            class="noteHint">eg: 1,3,5 or NULL</h6>
                                    <!-- To get the number of column fields in a file and render it on ref and sample columns -->
                                    <input type="text" name="NoOfColumns" value="<% columns.length %>" hidden=""
                                           id="NoOfColumns">
                                    <select name="ref[]" id="refselect" multiple="" size="5" style="width:100%;"
                                            ng-model='refselect' ng-show="columns.length > 0">
                        ...
                        <div class="stepsdiv" id="sample-div">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-7">
                                    <input class="ex8" name="samples" id="sample" value={{$sample}} > <h6
                                            class="noteHint">eg: 2,4,6 or NULL</h6>
                                    <select name="sample[]" id="sampleselect" multiple="" size="5" style="width:100%;"
                                            ng-model='sampleselect' ng-show="columns.length > 0">
                                        <option ng-repeat="column in columns track by $index"
                                                value="<% $index+1 %>">
                                            <% column %>
                                        </option>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-7">
                                    <select name="compare" class="styled-select" id="compare" class="compare">
                                        <option value="paired" @if (strcmp($compare,'paired') == 0 ) selected @endif >
                                            paired
                                        </option>
                                        <option value="unpaired"
                                                @if (strcmp($compare,'unpaired') == 0 ) selected @endif >unpaired
                                        </option>
                                        <option value="1ongroup"
                                                @if (strcmp($compare,'1ongroup') == 0 ) selected @endif>1ongroup
                                        </option>
                                        <option value="as.group"
                                                @if (strcmp($compare,'as.group') == 0 ) selected @endif >as.group
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-5">
                                    <a href="gageTutorial#two_direction_test"
                                       ...
                                       title="To test for changes changes towards both directions simultaneously."
                                       target="_blank" class="scrollToTop" style="float:left;margin-right:5px;">
                                        <span class="glyphicon glyphicon-info-sign" style="margin-right: 20px;"></span>
                                    </a>
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-5">
                                    <a href="gageTutorial#rank_test"
                                       ...
                                       title="whether do the optional rank based two-sample t-test." target="_blank"
                                ...
                                <div class="col-sm-7">
                                    <input type="checkbox" id="rankTest" style="width: 44px;" value="true"
                                           name="rankTest" @if ($rankTest) checked @endif >
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-5">
                                    <a href="gageTutorial#per_gene_score"
                                       ...
                                       title="Whether to use fold changes or t-test statistics as per gene statistics."
                                       target="_blank" class="scrollToTop" style="float:left;margin-right:5px;">
                                        <span class="glyphicon glyphicon-info-sign" style="margin-right: 20px;"></span>
                                    </a>
                                ...
                                <div class="col-sm-7">
                                    <input type="checkbox" id="useFold" value="true" data-off-text="t-test"
                                           data-on-text="fold" name="useFold" @if ($useFold) checked @endif>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-5">
                                    <a href="gageTutorial#gene_set_test"
                                       ...
                                       title="Function used for gene set tests for single array based analysis."
                                       target="_blank" class="scrollToTop" style="float:left;margin-right:5px;">
                                        <span class="glyphicon glyphicon-info-sign" style="margin-right: 20px;"></span>
                                    </a>
                                ...
                                <div class="col-sm-7">
                                    <select name="test" id="test" class="styled-select" class="compare">
                                        <option value="gs.tTest" @if (strcmp($test,'gs.tTest') == 0 ) selected @endif >
                                            t-test
                                        </option>
                                        <option value="gs.zTest" @if (strcmp($test,'gs.zTest') == 0 ) selected @endif >
                                            z-test
                                        </option>
                                        <option value="gs.KSTest"
                                                @if (strcmp($test,'gs.KSTest') == 0 ) selected @endif >
                        ...
                        <div class="stepsdiv" id="glow-clow-div"<?php if (isset(Session::get('err_atr')['glow'])) {
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input class="color coloration {hash:true}" id="clow" name="clow"
                        ...
                        <div class="stepsdiv" id="gmid-cmid-div" <?php if (isset(Session::get('err_atr')['gmid'])) {
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input class="color coloration {hash:true}" id="cmid" name="cmid"
                                           style="margin-left:50px"
                        ...
                        <div class="stepsdiv" id="ghigh-chigh-div"<?php if (isset(Session::get('err_atr')['ghigh'])) {
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input class="color coloration {hash:true}" id="chigh" name="chigh"
                                           style="margin-left:50px"
