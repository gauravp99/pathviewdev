...
@section('content')
    ...
    <div class="col-md-9">
        <div class="conetent-header ">
            <p><b>Example GAGE Analysis 3: Compound Data with Pathview</b></p>
        </div>
    ...
    <div class="col-md-7">
        ...
        <div id="content">
            <div id="wrapper"  ng-app="GageApp" ng-controller="ExampleAnalysisController3">
                ...
                <div id="steps">
                    {!! form::open(array('url' => 'exampleGageAnalysis3','method'=>'POST','files'=>true,'id' => 'gage_anal_form','name'=>'gage_anal_form')) !!}
                    <fieldset class="step inputOutput-step">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <div class="input-group">
                                        ...
                                        &nbsp;&nbsp;<a href="/data/sim.cpd.cnames.txt" target="_blank">sim.cpd.cnames.txt</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <script>
                            $( document ).ready(function() {
                                ...
                                $('#usePathview').change();
                                $('#dataType').val("compound");
                                $('#dataType').change();
                                $('#geneIdType').val("Compound name");


                                //selecting reference and samples
                                $("#refselect option[value=1]")[0].setAttribute("selected",true);
                                $("#refselect option[value=2]")[0].setAttribute("selected",true);

                                $("#refselect option[value=3]")[0].setAttribute("disabled",true);
                                $("#refselect option[value=4]")[0].setAttribute("disabled",true);



                                $("#sampleselect option[value=1]")[0].setAttribute("disabled",true);
                                $("#sampleselect option[value=2]")[0].setAttribute("disabled",true);

                                $("#sampleselect option[value=3]")[0].setAttribute("selected",true);
