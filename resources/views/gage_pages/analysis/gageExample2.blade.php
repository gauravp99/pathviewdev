...
@section('content')
    ...
    <div class="col-md-9">
        <div class="conetent-header ">
            <p><b>Example GAGE Analysis 2: Gene Data with Custom Gene Sets</b></p>
        </div>
    ...
    <div class="col-md-7">
        ...
        <div id="content">
        <div id="wrapper"  ng-app="GageApp" ng-controller="ExampleAnalysisController2">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-7">
                                ...
                                <div class="input-group">
                                    ...
                                    &nbsp;&nbsp; <a href="/data/gse16873.symb.txt" target="_blank">gse16873.symb.txt</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @include('gageAnalysis')
                    <script>
                        $( document ).ready(function() {
                            ...
                            //disable all options in geneset except custom
                            $('#geneSet option').attr('disabled',true);
                            $('#geneSet').val('');
                            $("#geneSet option[value='custom']")[0].removeAttribute('disabled');
                            $("#geneSet option[value='custom']")[0].setAttribute('selected','selected');
