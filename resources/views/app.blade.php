...
<head>
    ...
    <link rel="icon" href="/images/plogo.png" height="160px" sizes="32x32">
    ...
    <div class="container-fluid">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
             ...
             <a class="navbar-brand" href="{{ url('/') }}"><img src="/images/plogo.png" height="58px" style="margin-top: -15px;background-color: white;padding:3px;margin-left:-18px;">
             </a>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li <?php
                                    if (basename($_SERVER['PHP_SELF']) == "prev_anal") {
                                        echo "class=\"active\"";
                                        }
                                    ?>
                                    >
                            ...
                            <li <?php
                                    if (basename($_SERVER['PHP_SELF']) == "user") {
                                        echo "class=\"active\"";
                                        }
                                    ?>>
