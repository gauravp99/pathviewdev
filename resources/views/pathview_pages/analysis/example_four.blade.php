    ...
    <div id="content" ng-app="PathviewApp">
        <div id="wrapper">
            ...
            <div id="steps" ng-controller="example2Controller">
                ...
                {!! form::open(array('url' => 'post_exampleAnalysis4','method'=>'POST','files'=>true,'id' =>
                'anal_form')) !!}
                ...
                <fieldset class="step">
                    ...
                    <div class="stepsdiv" id="cfile-div" @if (isset(Session::get('err_atr')['cfile']))
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-7">
                                ...
                                <a href="/data/sim.cpd.gse16873.csv" target="_blank">{{$cpdfile}}</a>
                            </div>
                        </div>
                   ...
                   @include('analysis', ['example_analysis_4' => 'true'])
