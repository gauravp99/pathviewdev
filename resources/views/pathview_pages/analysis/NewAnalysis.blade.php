                                ...
                                <div class="col-sm-8">
                                    <div class="col-sm-2" style="font-size: 18px;visibility:hidden;margin-top:10px;"
                                        ...
                                        <a href=""><span class="glyphicon glyphicon-trash" id="clearFile"
                                                         onclick="reset($('#assayData'))"></span></a>
                                    </div>
                                    <div class="col-sm-10">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <p style="display: inline;margin-right:10px;">Paired</p> <input
                                                                ...
                                                                ng-model="GeneCompare" ng-init="checked=true"
                                                                checked="">
                                                    </div>
                                                </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-8" style="display: inline-block;">
                                    <div class="col-sm-2" style="font-size: 18px;visibility:hidden;margin-top:10px;"
                                        ...
                                        <a href=""><span class="glyphicon glyphicon-trash" id="clearFile"
                                                         onclick="reset($('#cpdassayData'))"></span></a>
                                    </div>
                                    <div class="col-sm-10">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-7">
                                                    <p style="display: inline;margin-right:10px;">Paired</p> <input
                                                            ...
                                                            name="cpdCompare" ng-model="CpdCompare" ng-init="checked=true"
                                                            checked="true">
                                                </div>
                                            </div>
