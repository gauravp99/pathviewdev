        ...
        function save()
        {
            ...
            //16. usePathview
            var  usePathview = $("#usePathview").val();
        ...
        function reDisplay() {
            ...
            if (arr !== "undefined" && $.trim(inputString)) {
                ...
                $.each(refselectOptions, function (index, value) {
                    $("#refselect").append("<option></option>").attr("value", value).attr("text", value);
                });
                ...
                $.each(sampleselectOptions, function (index, value) {
                    $("#sampleselect").append("<option></option>").attr("value", value).attr("text", value);
                });
                    ...
                    $('#geneSet').change(function () {
                        ...
                        if (dataType == "compound") {
                            ...
                            if ($(this).val() == null) {
                                ...
                                var molecularSet = ['Metabolic Pathways',
                                    'Physiological Pathways', 'Signaling Pathways',
                                    'Drug Metabolism Pathways', 'Drug Action Pathways',
                                    'Disease Pathways', 'All'];
                                $.each(molecularSet, function (index, value) {
