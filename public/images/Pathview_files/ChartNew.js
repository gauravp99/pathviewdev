...
//			barStrokeStyle: "solid",
    ...
    function init_and_start(ctx, data, config) {
        ...
        if (typeof jsGraphAnnotate[ctx.ChartNewId] == "undefined") jsGraphAnnotate[ctx.ChartNewId] = [];
        ...
        function drawAllSegments(animationDecimal) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (!(typeof(data[i].value) == 'undefined')) {
                    ...
                    ctx.closePath();
                    ctx.fillStyle = setOptionValue("COLOR", ctx, data, statData, data[i].color, config.defaultFillColor, i, -1, {
                    ...
                    if (config.segmentShowStroke) {
                        ...
                        ctx.setLineDash(lineStyleFn(setOptionValue("SEGMENTSTROKESTYLE", ctx, data, statData, data[i].segmentStrokeStyle, config.segmentStrokeStyle, i, -1, {
                            animationDecimal: animationDecimal,
                            scaleAnimation: scaleAnimation
                        })));
                        ctx.stroke();
        ...
        function drawAllDataPoints(animationDecimal) {
            ...
            for (var i = 0; i < data.datasets.length; i++) {
                ...
                if (config.datasetFill) {
                    ctx.fillStyle = setOptionValue("COLOR", ctx, data, statData, data.datasets[i].fillColor, config.defaultFillColor, i, -1, {
        ...
        function drawBars(animPc) {
            ...
            for (var i = 0; i < data.datasets.length; i++) {
                for (var j = 0; j < data.datasets[i].data.length; j++) {
                    ...
                    ctx.fillStyle = setOptionValue("COLOR", ctx, data, statData, data.datasets[i].fillColor, config.defaultFillColor, i, j, {
                        animationValue: currentAnimPc,
            ...
            if (lgtxt != "") {
                ...
                if (lgdbox) {
                    ...
                    if (legendMsr.drawLegendOnData) {
                        ctx.strokeStyle = setOptionValue("LEGENDSTROKECOLOR", ctx, data, undefined, data.datasets[orderi].strokeColor, config.defaultFillColor, orderi, -1, {
                            animationValue: 1,
                            xPosLeft: xpos,
                            yPosBottom: ypos,
                            xPosRight: xpos + config.legendBlockSize,
                            yPosTop: ypos - config.legendFontSize
                        });
                        ctx.setLineDash(lineStyleFn(setOptionValue("LEGENDLINEDASH", ctx, data, undefined, data.datasets[orderi].datasetStrokeStyle, config.datasetStrokeStyle, orderi, -1, {
                            animationValue: 1,
                            xPosLeft: xpos,
                            yPosBottom: ypos,
                            xPosRight: xpos + config.legendBlockSize,
                        ...
                        ctx.strokeStyle = setOptionValue("LEGENDSTROKECOLOR", ctx, data, undefined, data[orderi].strokeColor, config.defaultFillColor, orderi, -1, {
                            animationValue: 1,
                            xPosLeft: xpos,
                            yPosBottom: ypos,
                            xPosRight: xpos + config.legendBlockSize,
                        ...
                        ctx.setLineDash(lineStyleFn(setOptionValue("LEGENDSEGMENTTROKESTYLE", ctx, data, undefined, data[orderi].segmentStrokeStyle, config.segmentStrokeStyle, orderi, -1, {
                            animationValue: 1,
                            xPosLeft: xpos,
                            yPosBottom: ypos,
                            xPosRight: xpos + config.legendBlockSize,
                    ...
                    ctx.closePath();
                    if (legendMsr.drawLegendOnData) {
                        ctx.fillStyle = setOptionValue("LEGENDFILLCOLOR", ctx, data, undefined, data.datasets[orderi].fillColor, config.defaultFillColor, orderi, -1, {
                            animationValue: 1,
                            xPosLeft: xpos,
                            yPosBottom: ypos,
                            xPosRight: xpos + config.legendBlockSize,
                        ...
                        ctx.fillStyle = setOptionValue("LEGENDFILLCOLOR", ctx, data, undefined, data[orderi].color, config.defaultFillColor, orderi, -1, {
                            animationValue: 1,
                            xPosLeft: xpos,
                            yPosBottom: ypos,
                            xPosRight: xpos + config.legendBlockSize,
