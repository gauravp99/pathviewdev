...
setwd("/home/ybhavnasi/Desktop/Kegg")
if (file.exists(species)){
if(file.exists(paste(paste(species,pathway,sep=""),".txt",sep="")))
{
download.kegg(pathway.id = pathway, species = species, kegg.dir = paste("/home/ybhavnasi/Desktop/Kegg/",species,sep=""))
}
