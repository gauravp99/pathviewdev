...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->exec('sh '.public_path().'/scripts/biocStatsimport.sh')->hourly()->sendOutputTo($filePath);
        $schedule->exec('sh '.public_path().'/scripts/biocGageStatsimport.sh')->hourly()->sendOutputTo($filePath);
